...
export default class AnchorCommand extends Command {
	...
	constructor( editor ) {
		 ...
		 * that are used by the {@ganchor features/anchor anchor} and the
		 * {@ganchor features/image#anchoring-images anchoring images} features.
		 *
		 * @readonly
	 ...
	 * with the "anchor" prefix. For example, a `'anchorMyDecorator'` attribute
