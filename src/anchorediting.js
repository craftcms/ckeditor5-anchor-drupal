...
import { MouseObserver } from 'ckeditor5/src/engine.js';
import { findAttributeRange, inlineHighlight, Input, TwoStepCaretMovement } from 'ckeditor5/src/typing.js';
...
import { viewToModelPositionOutsideModelElement } from 'ckeditor5/src/widget.js';
import {
	createAnchorElement,
	createEmptyAnchorElement,
	createEmptyPlaceholderAnchorElement,
	ensureSafeUrl,
